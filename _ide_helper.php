...
namespace Illuminate\Support {
    ...
    class Collection
    {
        ...
        {
            return Collection::downloadExcel($fileName, $writerType, $withHeadings);
        }
...
namespace Akaunting\Module {
    ...
    class Facade
    {
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Akaunting\Module\FileRepository
            LaravelFileRepository::mixin($mixin, $replace);
        }
...
namespace Yajra\DataTables\Facades {
    ...
    class DataTables
    {
         ...
         * DataTables using Collection.
         *
         * @param  AnonymousResourceCollection|array  $collection
