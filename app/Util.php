...
class Util {
    ...
    public static function getCode($str): string
    {
        $str = trim($str);
        return htmlspecialchars($str);
    }

    public static function parseCode($code, $lang = 'html', $height = 0): string
    {
        $height = $height > 0 ? 'style="height:' . $height . 'px"' : '';

        return '<pre class="language-' . $lang . '"   ' . $height . '><code class="language-' . $lang . '">' . htmlspecialchars(trim($code), ENT_QUOTES) . '</code></pre>';
    }
    ...
    public static function hasArrayValue($array, $path): bool
    {
        return self::getArrayValue($array, $path) !== null;
    }

    public static function getArrayPath( $array, $searchKey = '' ): bool|array
    {
    ...
    public static function matchArrayByKeyValue( $array, $searchKey, $searchValue ): bool
    {
        //create a recursive iterator to loop over the array recursively
        $iter = new RecursiveIteratorIterator(
            new RecursiveArrayIterator( $array ),
    ...
    public static function searchArrayByKeyValue( $array, $searchKey, $searchValue ): bool
    {
        $result = array();
    ...
    public static function separateCamelCase( $str ): string
    {
        $re           = '/
          (?<=[a-z])
          (?=[A-Z])
    ...
    public static function getHtmlAttributes($attributes): string
    {
        $result = array();
    ...
    public static function getHtmlClass($classes, $full = true): string
    {
        $result = array();
    ...
    public static function getCssVariables($variables, $full = true): string
    {
        $result = array();
     ...
     * @return string
     */
    public static function sampleDemoText(): string
    {
        $demo = '';
    ...
    public static function camelize($input, $separator = '_'): array|string
    {
