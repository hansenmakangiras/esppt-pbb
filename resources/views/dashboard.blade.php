            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Dashboard
                        ...
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <span x-data="{ message: 'I ❤️ Alpine' }" x-text="message"></span>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                    ...
                    <div class="me-4">
                        ...
                        <a href="#" class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
                           data-kt-menu-flip="top-end">
                            ...
                            {!! getSvgIcon('icons/duotone/Text/Filter.svg','svg-icon svg-icon-5 svg-icon-gray-500 me-1') !!}
                        ...
                        <div class="card card-xxl-stretch mb-5">
                            ...
                            <div class="card-header border-0 bg-danger py-5">
                                ...
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <button type="button" class="btn btn-sm btn-icon btn-color-white btn-active-white btn-active-color- border-0 me-n3"
                                            data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                        <!--begin::Svg Icon | path: icons/duotone/Layout/Layout-4-blocks-2.svg-->
                                        {!! getSvgIcon('icons/duotone/Layout/Layout-4-blocks-2.svg','svg-icon svg-icon-2') !!}
                                        <!--end::Svg Icon-->
                                    </button>
                                    <!--begin::Menu 3-->
                                ...
                                <div class="card-p mt-n20 position-relative">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                            ...
                                            {!! getSvgIcon('icons/duotone/Media/Equalizer.svg','svg-icon svg-icon-3x svg-icon-warning d-block my-2') !!}
                                            <!--end::Svg Icon-->
                                        ...
                                        <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                            ...
                                            {!! getSvgIcon('icons/duotone/Communication/Add-user.svg','svg-icon svg-icon-3x svg-icon-primary d-block my-2') !!}
                                            <!--end::Svg Icon-->
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="card card-xxl-stretch mb-5">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                ...
                                <div class="card-toolbar">
                                    <!--begin::Menu-->
                                    <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click"
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <div class="card-toolbar">
                                    <ul class="nav">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4 me-1" data-bs-toggle="tab"
                                               href="#kt_table_widget_5_tab_2">Week</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4" data-bs-toggle="tab"
                                        ...
                                        <div class="row row-cols-lg-2 g-10">
                                            <div class="col">
                                                <div class="fv-row mb-9">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-solid" name="calendar_event_start_date" placeholder="Pick a start date"
                                            ...
                                            <div class="col" data-kt-calendar="datepicker">
                                                <div class="fv-row mb-9">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-solid" name="calendar_event_start_time" placeholder="Pick a start time"
                                        ...
                                        <div class="row row-cols-lg-2 g-10">
                                            <div class="col">
                                                <div class="fv-row mb-9">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-solid" name="calendar_event_end_date" placeholder="Pick a end date"
                                            ...
                                            <div class="col" data-kt-calendar="datepicker">
                                                <div class="fv-row mb-9">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input class="form-control form-control-solid" name="calendar_event_end_time" placeholder="Pick a end time"
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header border-0 justify-content-end">
                                    <!--begin::Edit-->
                                    <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="tooltip" data-bs-dismiss="click"
                                    ...
                                    <!--end::Edit-->
                                    <!--begin::Edit-->
                                    <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" data-bs-dismiss="click"
                                    ...
                                    <!--end::Edit-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-color-gray-500 btn-active-icon-primary" data-bs-toggle="tooltip" title="Hide Event"
